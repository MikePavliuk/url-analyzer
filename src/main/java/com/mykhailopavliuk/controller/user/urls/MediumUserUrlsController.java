...
public class MediumUserUrlsController extends UserUrlsController {

    @Autowired
    public MediumUserUrlsController(FxWeaver fxWeaver, UrlService urlService, SettingsService settingsService) {
